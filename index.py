...
- Per-user session memory (in-memory, per cold start)
- Date & Time (IST)
- Developer info
"""
...
logger.info("%s v%s | Model: %s", BOT_NAME, BOT_VERSION, MODEL)
...
class handler(BaseHTTPRequestHandler):
    """Vercel serverless entrypoint — Telegram sends updates here via webhook."""

    def log_message(self, format, *args):
        pass  # suppress default HTTP logs, use our logger instead
